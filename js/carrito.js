...
const renderizarCarrito = () => {
  ...
  if (!carrito.length) {
    ...
    // También limpiamos el contador visualmente
    actualizarContador([]);
  ...
  carrito.forEach((producto, indice) => {
    ...
    btnEliminar.classList.add("btn-agregar");
  ...
  btnVaciar.classList.add("btn-agregar");
  btnVaciar.style.backgroundColor = "#f7bb2b";
  btnVaciar.style.color = "#222";
